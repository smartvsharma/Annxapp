...
.factory('UserService', ['$http', 'communicationService', function($http, communicationService) {
	...
	service.addoffer=function(details,callback){ 
		var jsondata ={ "coupon_name":details.coupon_name,"category_id":details.category_id,"title":details.title,"start_date":details.start_date,"valid_date":details.valid_date,"createdDate":Date.now(),"modifiedDate":Date.now()}
